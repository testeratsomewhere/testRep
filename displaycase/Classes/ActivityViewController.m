...
- (void)viewWillAppear:(BOOL)animated 
{
	...
	tblActivity.backgroundColor = [UIColor clearColor];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cell == nil) {
		...
		lbl.text= [NSString stringWithFormat:@"Item %d", indexPath.row];
		...
		UIImageView *imgview1=[[UIImageView alloc]initWithFrame:CGRectMake(15, 7, 30,30 )];
		[imgview1 setImage: [UIImage imageNamed:@"Image1.png"]];
